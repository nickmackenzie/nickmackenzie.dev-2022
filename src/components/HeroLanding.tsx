        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.600"}>
            <Flex w={"300px"} justify={"space-between"}>
              ...
              <Link
                href="https://www.linkedin.com/in/nick-mackenzie/"
                isExternal
              >
                <BsLinkedin size={"48px"} />
              </Link>
              <Link href="mailto:mackenzie.nick@outlook.com" isExternal>
                <HiOutlineMail size={"48px"} />
              </Link>
              <Link
                href="https://github.com/nickmackenzie/resume/blob/main/Nick%20MacKenzie%20-%20Resume.pdf"
                isExternal
              >
                <VscFilePdf size={"48px"} />
              </Link>
            </Flex>
          </Text>
          <Stack
